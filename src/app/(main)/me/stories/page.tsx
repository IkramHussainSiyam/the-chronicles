...
const DraftStoriesPage = () => {
  return (
    <div>
      <CommonCard.Root className="border-b border-border/60 pb-6 mb-6 last:border-none last:pb-0 last:mb-0">
        <div>
          <CommonCard.Content>
            ...
            <CommonCard.Body>
              Why You Should Avoid Using Server CardActions for Data Fetching in
              Next.js 15
            </CommonCard.Body>
          </CommonCard.Content>
...
export default DraftStoriesPage;
